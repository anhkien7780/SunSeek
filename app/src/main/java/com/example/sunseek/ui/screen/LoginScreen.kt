                ...
                navigationIcon = {
                    IconButton(
                        ...
                        if (screen != Screen.Login) Icon(
                            ...
                            contentDescription = "Back to the login side"
                        )
                    }
                }
            )
                    ...
                    OutlinedTextFieldFloatedLabel(
                        ...
                        suffix = {
                            IconButton(
                                ...
                                Icon(
                                    painter = if (!isVisibility) painterResource(R.drawable.visibility_off) else painterResource(
                ...
                AnimatedVisibility(
                    ...
                    OutlinedTextFieldFloatedLabel(
                        ...
                        prefix = {
                            Icon(
                                Icons.Rounded.Lock,
                                contentDescription = "Correct Password prefix icon"
                            )
                        },
                        suffix = {
                            IconButton(
